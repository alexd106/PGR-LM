...
rmarkdown::render("LM_3_multiple_exercise.Rmd", output_format = "pdf_document", output_file = "./exercises/LM_3_multiple_exercise.pdf", quiet = TRUE)
```
...
### Day 4
 ...
 - [Linear model with categorical and continuous explanatory variables](#PLACEHOLDER)
 
 \  
 
### Day 4

- [Linear model selection exercise](#PLACEHOLDER)
