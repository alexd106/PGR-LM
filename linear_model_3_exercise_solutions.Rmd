...
# models with only a single explanatory variable (LOGAREA only: R² = 0.59,
# FGRAZE only: R² = 0.49), suggesting that including both variables and their
...
**(Optional, for the lazy!)** And, if you want an even easier way, then we can use the `ggplot2` package (code in the solutions). Note: you will need to install the `ggplot2` package first if you don't already have it. 
