...
# (residuals range from around -15 to +8), whilst levels 2 and 4 are                                                     
...
# of variance assumption. The resonably balanced sample sizes across levels (between                                        # 11 and 17) offer some robustness, but this should not be ignored.                                                      
