...
Our old friend the `predict()` function solution (with the `segments()` function)
...
Our old friend the `predict()` function solution (with the `arrows()` function)
